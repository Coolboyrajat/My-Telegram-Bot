            ...
            if download.status() not in [
                ...
                if download.message.chat.type != 'private':
                    try:
                        ...
                        msg += f'\n<b>Source: </b><a href="https://t.me/c/{chatid}/{download.message.message_id}">Click Here</a>  \n<b>Own By:</b> ️<a href="https://t.me/{download.message.from_user.username}">{download.message.from_user.first_name}</a>  \n<b>Unique Id:</b> <code>{download.message.from_user.id}</code>'
                    except:
                        pass
                else:
                    msg += f'\n<b>Adder:</b> ️<code>{download.message.from_user.first_name}</code>  \n<b>Unique Id:</b> <code>{download.message.from_user.id}</code>'
